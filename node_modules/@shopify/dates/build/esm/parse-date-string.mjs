...
export function parseDateString(dateString, timeZone) {
  var dateTimeParts = parseDateStringParts(dateString);

  if (dateTimeParts == null) {
    return null;
  }

  var rawYear = dateTimeParts.year,
      rawMonth = dateTimeParts.month,
      rawDay = dateTimeParts.day,
      rawHour = dateTimeParts.hour,
      rawMinute = dateTimeParts.minute,
      rawSecond = dateTimeParts.second,
      rawMillisecond = dateTimeParts.millisecond,
      timeZoneOffset = dateTimeParts.timeZoneOffset,
      sign = dateTimeParts.sign,
      rawTimeZoneHour = dateTimeParts.timeZoneHour,
      rawTimeZoneMinute = dateTimeParts.timeZoneMinute;
