...
var DateTimeParts = (_dec = memoize(dateTimeCacheKey('year')), _dec2 = memoize(dateTimeCacheKey('month')), _dec3 = memoize(dateTimeCacheKey('day')), _dec4 = memoize(dateTimeCacheKey('weekday')), _dec5 = memoize(dateTimeCacheKey('hour')), _dec6 = memoize(dateTimeCacheKey('minute')), _dec7 = memoize(dateTimeCacheKey('second')), _dec8 = memoize(dateTimeCacheKey('timePartsFallback')), (_class = /*#__PURE__*/function () {
  ...
  _createClass(DateTimeParts, null, [{
    ...
    value: function getYear(date, timeZone) {
      ...
      var yearString = formatDate(date, 'en', {
        timeZone: timeZone,
        year: 'numeric'
      });
      var sanitisedYearString = sanitiseDateString(yearString);
    ...
    value: function getMonth(date, timeZone) {
      var monthString = formatDate(date, 'en', {
        timeZone: timeZone,
        month: 'numeric'
      });
      var sanitisedMonthString = sanitiseDateString(monthString);
    ...
    value: function getDay(date, timeZone) {
      var dayString = formatDate(date, 'en', {
        timeZone: timeZone,
        day: 'numeric'
      });
      var sanitisedDayString = sanitiseDateString(dayString);
    ...
    value: function getWeekday(date, timeZone) {
      var weekdayString = formatDate(date, 'en', {
        timeZone: timeZone,
        weekday: 'long'
      });
      var sanitisedWeekdayString = sanitiseDateString(weekdayString);
      return getWeekdayValue(sanitisedWeekdayString);
    }
  }, {
    key: "getHour",
    value: function getHour(date, timeZone) {
      var hourString = formatDate(date, 'en', {
        timeZone: timeZone,
        hour12: false,
        hour: 'numeric'
      });
    ...
    value: function getMinute(date, timeZone) {
      var minuteString = formatDate(date, 'en', {
        timeZone: timeZone,
        minute: 'numeric'
      });
    ...
    value: function getSecond(date, timeZone) {
      var secondString = formatDate(date, 'en', {
        timeZone: timeZone,
        second: 'numeric'
      });
    ...
    value: function getTimePartsFallback(date, timeZone) {
      var timeString = formatDate(date, 'en', {
        timeZone: timeZone,
        hour12: false,
        hour: '2-digit',
        minute: '2-digit',
