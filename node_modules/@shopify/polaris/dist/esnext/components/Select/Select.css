...
.Polaris-Select--newDesignLanguage_1rik8.Polaris-Select--error_37uk1 .Polaris-Select__Input_30ock:focus ~ .Polaris-Select__Backdrop_1x2i2::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }

.Polaris-Select--newDesignLanguage_1rik8 .Polaris-Select__Input_30ock:focus ~ .Polaris-Select__Backdrop_1x2i2::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
