...
import { buildCustomProperties, buildThemeContext, toString } from '../../utilities/theme/utils.ts.esnext';
...
function ThemeProvider({
  ...
  const [customProperties, theme] = useMemo(() => {
    ...
    const theme = { ...buildThemeContext(processedThemeConfig, newDesignLanguage ? customProperties : undefined),
