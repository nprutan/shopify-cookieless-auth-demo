...
class ConnectedFilterControl extends Component {
  ...
  render() {
    ...
    const moreFiltersButtonContainerClassname = classNames(styles.MoreFiltersButtonContainer, actionsToRender.length === 0 && (newDesignLanguage || queryFieldHidden) && styles.onlyButtonVisible);
