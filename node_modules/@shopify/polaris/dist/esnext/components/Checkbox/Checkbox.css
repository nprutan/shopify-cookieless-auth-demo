...
.Polaris-Checkbox_1d6zr.Polaris-Checkbox--newDesignLanguage_1rik8 .Polaris-Checkbox__Input_30ock.Polaris-Checkbox--keyFocused_1aqee + .Polaris-Checkbox__Backdrop_1x2i2::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
