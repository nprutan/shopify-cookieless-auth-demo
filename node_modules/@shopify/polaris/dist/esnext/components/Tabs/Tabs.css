...
.Polaris-Tabs__Tab_375k2:focus:not(:active) .Polaris-Tabs__Title_2qj8j::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
...
.Polaris-Tabs__Item_yiyol.Polaris-Tabs--newDesignLanguage_1rik8:active{ background-color:var(--p-surface-primary-selected-pressed); }

.Polaris-Tabs__Item_yiyol.Polaris-Tabs--newDesignLanguage_1rik8::after{ content:var(--p-non-null-content, none); position:absolute; z-index:1; top:-0.1rem; right:-0.1rem; bottom:-0.1rem; left:-0.1rem; display:block; pointer-events:none; box-shadow:0 0 0 -0.1rem var(--p-focused, #5c6ac4); transition:box-shadow 100ms var(--p-ease); border-radius:calc(var(--p-border-radius-base) + 0.1rem); }

.Polaris-Tabs__Item_yiyol.Polaris-Tabs--newDesignLanguage_1rik8:focus:not(:active)::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
...
.Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__DisclosureActivator_1mita:hover .Polaris-Tabs__Title_2qj8j{ background:none; }

.Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__DisclosureActivator_1mita:hover .Polaris-Tabs__Title_2qj8j::before{ background:var(--p-border-hovered); }

.Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__DisclosureActivator_1mita:focus .Polaris-Tabs__Title_2qj8j::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }

.Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__DisclosureActivator_1mita:focus .Polaris-Tabs__Title_2qj8j svg{ fill:var(--p-icon, #637381); }

.Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__DisclosureActivator_1mita:focus .Polaris-Tabs__Title_2qj8j::before{ background:var(--p-border-hovered); }

.Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__DisclosureActivator_1mita:active .Polaris-Tabs__Title_2qj8j::before{ background:var(--p-surface-primary-selected-pressed); }

.Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__Tab--selected_11sap:focus .Polaris-Tabs__Title_2qj8j{ outline:0.3rem solid transparent; }
...
.Polaris-Tabs--newDesignLanguage_1rik8 .Polaris-Tabs__Tab--selected_11sap .Polaris-Tabs__Title_2qj8j{ outline:0.3rem solid transparent; color:var(--p-text); }
