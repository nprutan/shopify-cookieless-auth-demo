...
.Polaris-Banner--withinContentContainer_1uwmg.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
...
.Polaris-Banner--withinContentContainer_1uwmg.Polaris-Banner--statusSuccess_pc5rl.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
...
.Polaris-Banner--withinContentContainer_1uwmg.Polaris-Banner--statusInfo_knr66.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
...
.Polaris-Banner--withinContentContainer_1uwmg.Polaris-Banner--statusWarning_1x66d.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
...
.Polaris-Banner--withinContentContainer_1uwmg.Polaris-Banner--statusCritical_1iy3d.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
...
.Polaris-Banner--withinPage_kguwn.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
...
.Polaris-Banner--withinPage_kguwn.Polaris-Banner--statusSuccess_pc5rl.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
...
.Polaris-Banner--withinPage_kguwn.Polaris-Banner--statusInfo_knr66.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
...
.Polaris-Banner--withinPage_kguwn.Polaris-Banner--statusWarning_1x66d.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
...
.Polaris-Banner--withinPage_kguwn.Polaris-Banner--statusCritical_1iy3d.Polaris-Banner--keyFocused_1aqee::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
...
.Polaris-Banner__SecondaryAction_1dl4i:focus > .Polaris-Banner__Text_yj3uv{ padding:2px 5px; margin:-2px -5px; background:rgba(33, 43, 54, 0.1); border-radius:3px; box-shadow:none; }
...
.Polaris-Banner__Button_r99lw.Polaris-Banner--newDesignLanguage_1rik8:hover{ background:var(--p-action-secondary-hovered); outline:0.1rem solid transparent; }
...
.Polaris-Banner__Button_r99lw.Polaris-Banner--newDesignLanguage_1rik8:focus::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
...
.Polaris-Banner__Button_r99lw:focus::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
