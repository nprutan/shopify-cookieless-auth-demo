:root{ --polaris-version-number:'5.13.0'; --polaris-animation-skeleton-shimmer:polaris-SkeletonShimmerAnimation; }
...
.Polaris-Scrollable:focus{ outline:none; }
...
.Polaris-Button--primary.Polaris-Button--newDesignLanguage{ position:relative; background:var(--p-button-color); border-color:transparent; box-shadow:var(--p-button-drop-shadow), var(--p-button-inner-shadow); color:var(--p-button-text); }
...
.Polaris-Button--destructive.Polaris-Button--newDesignLanguage{ position:relative; background:var(--p-button-color); border-color:transparent; box-shadow:var(--p-button-drop-shadow), var(--p-button-inner-shadow); color:var(--p-button-text); }
...
.Polaris-Button--outline.Polaris-Button--newDesignLanguage{ position:relative; background:transparent; border:0.1rem solid var(--p-border); box-shadow:none; color:var(--p-text); }
...
.Polaris-Button--outline.Polaris-Button--newDesignLanguage.Polaris-Button--destructive:focus::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
...
.Polaris-Button--destructive.Polaris-Button--outline.Polaris-Button--newDesignLanguage{ position:relative; background:transparent; border:0.1rem solid var(--p-border); box-shadow:none; color:var(--p-text); }
...
.Polaris-Button--destructive.Polaris-Button--outline.Polaris-Button--newDesignLanguage.Polaris-Button--destructive:focus::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
...
.Polaris-Button--destructive.Polaris-Button--outline.Polaris-Button--pressed.Polaris-Button--newDesignLanguage{ position:relative; background:transparent; border:0.1rem solid var(--p-border); box-shadow:none; color:var(--p-text); }
...
.Polaris-Button--destructive.Polaris-Button--outline.Polaris-Button--pressed.Polaris-Button--newDesignLanguage.Polaris-Button--destructive:focus::after{ box-shadow:0 0 0 0.2rem var(--p-focused, #5c6ac4); outline:0.1rem solid transparent; }
