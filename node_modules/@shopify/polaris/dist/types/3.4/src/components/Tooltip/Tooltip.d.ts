...
export declare function Tooltip({ children, content, light, dismissOnMouseOut, active: originalActive, preferredPosition, activatorWrapper, accessibilityLabel, }: TooltipProps): JSX.Element;
