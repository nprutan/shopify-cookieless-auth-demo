...
export declare function Header({ title, subtitle, titleMetadata, additionalMetaData, thumbnail, titleHidden, separator, primaryAction, pagination, additionalNavigation, breadcrumbs, secondaryActions, actionGroups, }: HeaderProps): JSX.Element;
export {};
